...
itmax=5000   !Max number of time steps
imean=100    !Number of time steps between writing mean profiles to output log file
ihst=1     !Number of time steps between writing profiles to history file
itape=50  !Number of time steps before opening new history file and writing full 3D volumes
itstr=1
...
method=3, idebug=1, iz_space=1, ivis0=1, ifix_dt=0, new_vis=-1
...
&path_names
path_seed="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_part="/scratch365/tpeng2/NTLP-SD/ABLtest/part.le.cou000"
path_res="/scratch365/tpeng2/NTLP-SD/ABLtest/u.le.cou000"
path_sav="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_his="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_viz_xy="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_viz_xz="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_viz_yz="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_stuf="/scratch365/tpeng2/NTLP-SD/ABLtest/"
path_ran="/scratch365/tpeng2/NTLP-SD/ABLtest/u.le.cou000"
path_histog="/scratch365/tpeng2/NTLP-SD/ABLtest/"
/
